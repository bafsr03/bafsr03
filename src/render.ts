...
const BP_MEDIUM = 550;
const BP_LARGE = 700;
const BODY_COPY = `I’m Brian Sanchez, a frontend developer and 3D designer, exploring blockchain and its impact on digital innovation`;
...
export const shared = /* css */ `
	:root {
		...
		--color-dot-bg-0-light: rgba(100, 100, 100, 0.5);
		...
		--color-dot-bg-0-dark: rgba(100, 100, 100, 0.5);
